 ...
 */
final class Version20220901085746 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE question CHANGE created_at created_at DATE NOT NULL COMMENT \'(DC2Type:date_immutable)\'');
    }
